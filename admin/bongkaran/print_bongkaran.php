...
foreach ($query_cek as $data) {
    $html .= '<tr>
        ...
        <td align="left" style="padding-left:10px">' . tanggal_indo($data_cek["tanggal_bongkaran"], true) . '</td>
        <td align="left" style="padding-left:10px">' . $data["container"] . '</td>
        <td align="right" style="padding-right:10px">Rp ' . number_format($data["sewa_mobil"] + $data["konsumsi"] + $data["forklift"] + $data["ekspedisi"] + $data["tol"] + $data["lainnya"] , 0, ",", ".") . '</td>
        <td align="right" style="padding-right:10px">Rp ' . number_format($data["uang_muka"] , 0, ",", ".") . '</td>
        </tr>';
}
